    ...
    void informasiRuanganBaca(Scanner input){
        ...
        while(true){
            ...
            for(int i = 0; i < this.pengguna.listPinjamanBuku.length; i++) {
                ...
                buku.setKembalikan(buku.decreaseKembalikan());
            }
        }
    }
...
class Denda{
    ...
    void cekDenda(){
        int totalDenda = 0;
        for(Book b : this.user.listPinjamanBuku){
            if(b.getKembalikan() < 0){
                System.out.println("Buku " + b.judul + " Telah melewatkan batas peminjaman, Dendan : 10.000");
                b.denda.denda = 10000;
                totalDenda += 10000;
            }
        }
